...
camrea_calibtation::camrea_calibtation(/* args */)
{
}

camrea_calibtation::~camrea_calibtation()
{
}
...
int main()
{
    ...
    // 输出相机参数
    writeCameraParametersToJson(mtx, dist, "/home/fish/GKD/RK3588_FPV_Master/settings/camera_paramets.json");
